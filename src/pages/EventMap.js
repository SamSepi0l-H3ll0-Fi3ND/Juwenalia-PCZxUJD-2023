...
const EventMap = () => {
  return (
    <div className="Main__background-img w-full h-fit">
      <div className="flex">
      ...
      <div className="  flex flex-nowrap max-[840px]:flex-wrap md:mx-6">
        <div className="w-full max-[400px]:mt-8 mt-4 mb-4" id="mapa">
          <img src={map} alt="map" />
        </div>
        <CardMap >
          <div className="flex flex-nowrap mt-4 ml-4" data-aos="fade-left">
            <Number>
              01
            </Number>
          ...
          <div className="flex flex-nowrap my-4 ml-4" data-aos="fade-left">
          <Number>
            04
          </Number>
            <p className="self-center text-white min-[400px]:text-3xl ml-4">
